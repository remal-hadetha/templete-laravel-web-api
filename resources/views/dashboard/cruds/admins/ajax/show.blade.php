    ...
    <div class="content content-boxed">
        <div class="row items-push text-center">
            <div class="col-6 col-md-3">
                <div class="font-size-sm font-w600 text-muted text-uppercase">المبيعات</div>
                <a class="link-fx font-size-h3" href="javascript:void(0)">17980</a>
            </div>
            <div class="col-6 col-md-3">
                <div class="font-size-sm font-w600 text-muted text-uppercase">المنتجات</div>
                <a class="link-fx font-size-h3" href="javascript:void(0)">27</a>
            </div>
            <div class="col-6 col-md-3">
                <div class="font-size-sm font-w600 text-muted text-uppercase">المستخدمين</div>
                <a class="link-fx font-size-h3" href="javascript:void(0)">1360</a>
            </div>
            <div class="col-6 col-md-3">
                <div class="font-size-sm font-w600 text-muted text-uppercase mb-2">739 التقيمات</div>
                ...
                <li class="timeline-event">
                    ...
                    <div class="timeline-event-block block invisible" data-toggle="appear">
                        <div class="block-header">
                            <h3 class="block-title">فيس بوك</h3>
                ...
                <div class="block-content">
                    <div class="font-size-sm push">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <div>
                                <a class="font-w600" href="">Barbara Scott</a>
                                <span class="text-muted">(5/5)</span>
                            </div>
                        </div>
                        <p class="mb-0">Flawless design execution! Im really impressed with the product, it really helped me build my app so fast! Thank you!</p>
                    </div>
                    <div class="font-size-sm push">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <div>
                                <a class="font-w600" href="">Brian Cruz</a>
                                <span class="text-muted">(5/5)</span>
                            </div>
                        </div>
                ...
                <div class="block-content">
                    <ul class="nav-items font-size-sm">
                        ...
                        <li>
                            <a class="media py-2" href="javascript:void(0)">
                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                    <img class="img-avatar img-avatar48" src="{{asset('media/avatars/avatar1.jpg')}}" alt="">
