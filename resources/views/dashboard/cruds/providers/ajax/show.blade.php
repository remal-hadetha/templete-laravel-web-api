    ...
    <div class="content content-boxed">
        <div class="row items-push text-center">
            <div class="col-6 col-md-3">
                ...
                <a class="link-fx font-size-h3" href="javascript:void(0)">{{$data->providerOrders->count()}}</a>
            </div>
            <div class="col-6 col-md-3">
                <div class="font-size-sm font-w600 text-muted text-uppercase">عدد الخدمات في الطلبات</div>
                @php
                    $ids  = $data->providerOrders()->with('servicesCount')->get();
                    $servicesCount = 0 ;
                    foreach ($ids as $item){
            ...
            <div class="col-6 col-md-3">
                ...
                <a class="link-fx font-size-h3" href="javascript:void(0)">{{$data->salonContacts->count()}}</a>
            </div>
            <div class="col-6 col-md-3">
                <div class="font-size-sm font-w600 text-muted text-uppercase">القسم</div>
                <a class="link-fx font-size-h3" href="javascript:void(0)">{{$data->category->name_ar}}</a>
            </div>
    ...
    <div class="row">
        <div class="col-md-7 col-xl-8">
            ...
            <ul class="timeline timeline-alt py-0">
                    ...
                    <div class="timeline-event-block block invisible" data-toggle="appear">
                        <div class="block-header">
                            ...
                            <div class="block-options">
                                <div class="timeline-event-time block-options-item font-size-sm">
                                    @if(count($data->providerOrders) > 0 )
                                        {{$data->providerOrders->last()->created_at->diffForHumans()}}
                        ...
                        <div class="block-content block-content-full">
                            <p class="font-w600 mb-2">
                                ...
                                {{optional($data->providerOrders->last())->servicesCount}}

                            </p>
                            <div class="d-flex">
                                @if(count($data->providerOrders) > 0)
                                @forelse ($data->providerOrders->last()->services as $item)
                ...
                <li class="timeline-event">
                    ...
                    <div class="timeline-event-block block invisible" data-toggle="appear">
                        <div class="block-header">
                            ...
                            <div class="block-options">
                                <div class="timeline-event-time block-options-item font-size-sm">
                                    @if ($data->salonContacts->last())
                                        {{$data->salonContacts->last()->created_at}}
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="block-content">
                            <p class="font-w600 mb-2">
                                @if ($data->salonContacts->last())
                                    {{$data->salonContacts->last()->message}}
                                @endif
                           </p>
                        </div>
                    </div>
                ...
                <li class="timeline-event">
                    ...
                    <div class="timeline-event-block block invisible" data-toggle="appear">
                        <div class="block-header">
                            <h3 class="block-title"> كل الآعمال</h3>
                            <div class="block-options">
                                <div class="timeline-event-time block-options-item font-size-sm">
        ...
        <div class="col-md-5 col-xl-4">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    @forelse ($data->providerOrders->take(4) as $item)
            ...
            <div class="block">
                ...
                <div class="block-content">
                    @forelse ($data->reviews->take(3) as $item)
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <ul class="nav-items font-size-sm">
                      @forelse ($data->providerOrders->take(3) as $item)

                      <li>
                        <a class="media py-2" href="javascript:void(0)">
                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                <img class="img-avatar img-avatar48" src="{{$item->user->ImageURL}}" alt="">
                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                            </div>
                            <div class="media-body">
                                <div class="font-w600">{{$item->user->name}}</div>
                                <div class="font-w400 text-muted">{{$item->user->email}}</div>
                            </div>
                        </a>
                    </li>
